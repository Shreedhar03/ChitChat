    ...
    return (
        <div className='h-screen bg-primary flex flex-col items-center pt-12'>
            ...
            <form className='flex flex-col mt-12 gap-3' onSubmit={handleSubmit}>
                <input type="text" onChange={handleChange} name='fname' value={credentials.fname} required className='text-lg focus:outline-none px-3 py-2 bg-[#434086] placeholder:text-gray-400 placeholder:text-[16px] text-gray-900 font-semibold rounded-xl' placeholder='First Name' autoComplete='off' />
                <input type="text" onChange={handleChange} name='lname' value={credentials.lname} required className='text-lg focus:outline-none px-3 py-2 bg-[#434086] placeholder:text-gray-400 placeholder:text-[16px] text-gray-900 font-semibold rounded-xl' placeholder='Last Name' autoComplete='off' />
                ...
                <input type="text" onChange={handleChange} name='conPass' value={credentials.conPass} required className='text-lg focus:outline-none px-3 py-2 bg-[#434086] placeholder:text-gray-400 placeholder:text-[16px] text-gray-900 font-semibold rounded-xl' placeholder='Confirm Password' autoComplete='off' />
