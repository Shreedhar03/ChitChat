    ...
    return (
        <div className='h-screen bg-slate-200 flex flex-col items-center pt-12'>
            ...
            <form className='flex flex-col mt-12 gap-3' onSubmit={handleSubmit}>
                ...
                <input type="password" onChange={handleChange} name='conPass' value={credentials.conPass} required className='text-lg focus:outline-none px-3 py-2 bg-slate-400 placeholder:text-gray-800 placeholder:text-[16px] text-gray-900 font-semibold rounded-xl' placeholder='Confirm Password' autoComplete='off' />
