...
const { registerUser, loginUser, searchUser, accessChat, fetchChats, createGroupChat, sendMessage, allMessages,updatePic } = require('../Controllers/userControllers')
...
router.post('/updatePic',authenticateUser,updatePic)
